...
//        spawnNode.position = CGPoint(x: frame.midX, y: frame.midY - 390)
//        addChild(spawnNode)
//        
...
//        let scaleSeq = SKAction.sequence([scalePrelim, scaleMenuButtonsUp])
//        
//        let moveScore = SKAction.move(to: CGPoint(x: gameOverWindow.frame.midX, y: gameOverWindow.frame.midY + 50), duration: 2.2)
//        let pulseUp = SKAction.scale(to: 2.0, duration: 1.1)
//        let pulseDown = SKAction.scale(to: 1, duration: 1.1)
//        
